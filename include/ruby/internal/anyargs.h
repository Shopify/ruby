...
# define RBIMPL_ANYARGS_DECL(sym, ...) \
  ...
  static void sym##_notimpl(__VA_ARGS__, VALUE (*)(int, const VALUE *, VALUE, VALUE), int); \
  RBIMPL_ANYARGS_ATTRSET(sym) \
  static void sym##_m3(__VA_ARGS__, VALUE (*)(ANYARGS), int); \
  RBIMPL_ANYARGS_ATTRSET(sym) \
  static void sym##_m2(__VA_ARGS__, VALUE (*)(VALUE, VALUE), int); \
  RBIMPL_ANYARGS_ATTRSET(sym) \
  static void sym##_m1(__VA_ARGS__, VALUE (*)( \
                                      int, union { VALUE *x; const VALUE *y; } __attribute__((__transparent_union__)), VALUE), \
    int); \
  RBIMPL_ANYARGS_ATTRSET(sym) \
  static void sym##_00(__VA_ARGS__, VALUE (*)(VALUE), int); \
  RBIMPL_ANYARGS_ATTRSET(sym) \
  static void sym##_01(__VA_ARGS__, VALUE (*)(VALUE, VALUE), int); \
  RBIMPL_ANYARGS_ATTRSET(sym) \
  static void sym##_02(__VA_ARGS__, VALUE (*)(VALUE, VALUE, VALUE), int); \
  RBIMPL_ANYARGS_ATTRSET(sym) \
  static void sym##_03(__VA_ARGS__, VALUE (*)(VALUE, VALUE, VALUE, VALUE), int); \
  RBIMPL_ANYARGS_ATTRSET(sym) \
  ...
  RBIMPL_ANYARGS_ATTRSET(sym) \
  static void sym##_08(__VA_ARGS__, VALUE (*)(VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE), int); \
  RBIMPL_ANYARGS_ATTRSET(sym) \
  static void sym##_09(__VA_ARGS__, VALUE (*)(VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE), int); \
  RBIMPL_ANYARGS_ATTRSET(sym) \
  static void sym##_10(__VA_ARGS__, VALUE (*)(VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE), int); \
  RBIMPL_ANYARGS_ATTRSET(sym) \
  static void sym##_11(__VA_ARGS__, VALUE (*)(VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE), int); \
  RBIMPL_ANYARGS_ATTRSET(sym) \
  static void sym##_12(__VA_ARGS__, VALUE (*)(VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE), int); \
  RBIMPL_ANYARGS_ATTRSET(sym) \
  static void sym##_13(__VA_ARGS__, VALUE (*)(VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE), int); \
  RBIMPL_ANYARGS_ATTRSET(sym) \
  static void sym##_14(__VA_ARGS__, VALUE (*)(VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE), int); \
  RBIMPL_ANYARGS_ATTRSET(sym) \
  static void sym##_15(__VA_ARGS__, VALUE (*)(VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE, VALUE), int);
