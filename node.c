...
#define FIELD_NAME_LEN(name, ann) (int)(comment ? \
...
rb_node_buffer_new(void)
{
    ...
    STATIC_ASSERT(
      integer_overflow,
      offsetof(node_buffer_elem_t, buf) + NODE_BUF_DEFAULT_LEN * sizeof(NODE) > sizeof(node_buffer_t) + 2 * sizeof(node_buffer_elem_t));
