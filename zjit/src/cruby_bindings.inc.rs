...
pub const RUBY_OFFSET_ISEQ_BODY: jit_bindgen_constants = 8;
pub const RUBY_OFFSET_ISEQ_BODY_PARAM_FLAGS: jit_bindgen_constants = 16;
pub const RUBY_OFFSET_ISEQ_BODY_PARAM_LEAD_NUM: jit_bindgen_constants = 24;
pub const RUBY_OFFSET_ISEQ_BODY_LOCAL_TABLE_SIZE: jit_bindgen_constants = 192;
pub const RUBY_OFFSET_ISEQ_BODY_STACK_MAX: jit_bindgen_constants = 216;
pub const RUBY_OFFSET_ISEQ_BODY_JIT_PAYLOAD: jit_bindgen_constants = 280;
