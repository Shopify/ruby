...
#endif
#ifndef GC_HEAP_UNCOLLECTIBLE_WB_UNPROTECTED_OBJECTS_LIMIT_RATIO
# define GC_HEAP_UNCOLLECTIBLE_WB_UNPROTECTED_OBJECTS_LIMIT_RATIO 0.01
#endif
...
static ruby_gc_params_t gc_params = {
    ...
    GC_HEAP_UNCOLLECTIBLE_WB_UNPROTECTED_OBJECTS_LIMIT_RATIO,
...
ruby_gc_set_params(void)
{
    ...
    get_envparam_double("RUBY_GC_HEAP_UNCOLLECTIBLE_WB_UNPROTECTED_OBJECTS_LIMIT_RATIO", &gc_params.uncollectible_wb_unprotected_objects_limit_ratio, 0.0, 0.0, TRUE);
