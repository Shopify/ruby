...
typedef struct gc_function_map {
    ...
    bool (*zjit_write_barrier_fastpath)(void *objspace_ptr, size_t *flags_offset, size_t *incremental_marking_mask);
...
# define load_modular_gc_func(name) do { \
    ...
    load_modular_gc_func(zjit_write_barrier_fastpath);
...
# define rb_gc_impl_zjit_write_barrier_fastpath rb_gc_functions.zjit_write_barrier_fastpath
...
bool
rb_gc_zjit_write_barrier_fastpath(size_t *flags_offset, size_t *incremental_marking_mask)
{
#if defined(RUBY_ASAN_ENABLED)
    (void)rb_gc_impl_zjit_write_barrier_fastpath;
    (void)flags_offset;
    (void)incremental_marking_mask;
    return false;
#else
    return rb_gc_impl_zjit_write_barrier_fastpath(rb_gc_get_objspace(), flags_offset, incremental_marking_mask);
#endif
}
