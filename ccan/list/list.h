...
static inline void
ccan_list_add_after_(struct ccan_list_head *h,
...
static inline void
ccan_list_add_(struct ccan_list_head *h,
  struct ccan_list_node *n,
  const char *abortstr)
{
...
static inline void
ccan_list_add_before_(struct ccan_list_head *h,
  struct ccan_list_node *p,
  struct ccan_list_node *n,
  const char *abortstr)
{
...
static inline void
ccan_list_add_tail_(struct ccan_list_head *h,
  struct ccan_list_node *n,
  const char *abortstr)
{
...
static inline void
ccan_list_swap_(struct ccan_list_node *o,
  struct ccan_list_node *n,
  const char *abortstr)
{
...
#define ccan_list_append_list(t, f) ccan_list_append_list_(t, f, \
  __FILE__ ":" ccan_stringify(__LINE__))
static inline void
ccan_list_append_list_(struct ccan_list_head *to,
...
static inline void
ccan_list_prepend_list_(struct ccan_list_head *to,
  struct ccan_list_head *from,
  const char *abortstr)
{
    struct ccan_list_node *from_tail = ccan_list_debug(from, abortstr)->n.prev;
...
static inline void *
ccan_list_entry_or_null(const struct ccan_list_head *h,
