...
bool rb_yjit_threshold_hit(const rb_iseq_t *const iseq, const rb_execution_context_t *ec);
...
static inline bool rb_yjit_threshold_hit(const rb_iseq_t *const iseq, const rb_execution_context_t *ec) { return false; }
