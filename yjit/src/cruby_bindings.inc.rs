...
pub const RUBY_EVENT_COVERAGE_LINE: u32 = 65536;
pub const RUBY_EVENT_COVERAGE_BRANCH: u32 = 131072;
...
extern "C" {
    pub static mut ruby_vm_event_enabled_global_flags: rb_event_flag_t;
}
...
extern "C" {
    pub fn rb_yarv_ec_ractor_hooks(ec: *const rb_execution_context_t) -> *mut rb_hook_list_t;
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
