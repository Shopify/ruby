...
VALUE
var_2x_getter(ID id, VALUE *data)
{
    return *data;
}

void
var_2x_setter(VALUE val, ID id, VALUE *var)
{
    *var = INT2NUM(NUM2INT(val) * 2);
}

static VALUE
sb_define_hooked_variable(VALUE self, VALUE var_name)
{
...
static VALUE
sb_define_hooked_variable_default_accessors(VALUE self, VALUE var_name)
{
...
static VALUE
sb_define_hooked_variable_null_var(VALUE self, VALUE var_name)
{
...
static VALUE
sb_define_readonly_variable(VALUE self, VALUE var_name, VALUE val)
{
    g_ro_var = val;
...
static VALUE
sb_get_global_value(VALUE self)
{
    return g_var;
}

static VALUE
sb_define_variable(VALUE self, VALUE var_name, VALUE val)
{
    g_var = val;
...
VALUE
incrementing_getter(ID id, VALUE *data)
{
    return LONG2FIX(virtual_var_storage++);
}

void
incrementing_setter(VALUE val, ID id, VALUE *data)
{
    virtual_var_storage = FIX2LONG(val);
}

static VALUE
sb_define_virtual_variable_default_accessors(VALUE self, VALUE name)
{
...
static VALUE
sb_define_virtual_variable_incrementing_accessors(VALUE self, VALUE name)
{
...
static VALUE
sb_f_global_variables(VALUE self)
{
    return rb_f_global_variables();
}

static VALUE
sb_gv_get(VALUE self, VALUE var)
{
    return rb_gv_get(StringValuePtr(var));
}

static VALUE
sb_gv_set(VALUE self, VALUE var, VALUE val)
{
    return rb_gv_set(StringValuePtr(var), val);
}

static VALUE
global_spec_rb_stdin(VALUE self)
{
    return rb_stdin;
}

static VALUE
global_spec_rb_stdout(VALUE self)
{
    return rb_stdout;
}

static VALUE
global_spec_rb_stderr(VALUE self)
{
    return rb_stderr;
}

static VALUE
global_spec_rb_defout(VALUE self)
{
    return rb_defout;
}

static VALUE
global_spec_rb_fs(VALUE self)
{
    return rb_fs;
}

static VALUE
global_spec_rb_rs(VALUE self)
{
    return rb_rs;
}

static VALUE
global_spec_rb_default_rs(VALUE self)
{
    return rb_default_rs;
}

static VALUE
global_spec_rb_output_rs(VALUE self)
{
    return rb_output_rs;
}

static VALUE
global_spec_rb_output_fs(VALUE self)
{
    return rb_output_fs;
}

static VALUE
global_spec_rb_lastline_set(VALUE self, VALUE line)
{
...
static VALUE
global_spec_rb_lastline_get(VALUE self)
{
    return rb_lastline_get();
}

void
Init_globals_spec(void)
{
