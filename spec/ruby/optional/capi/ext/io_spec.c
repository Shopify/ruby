...
VALUE
io_spec_rb_thread_fd_select_read(VALUE self, VALUE io)
{
    int fd = io_spec_get_fd(io);
...
VALUE
io_spec_rb_thread_fd_select_write(VALUE self, VALUE io)
{
    int fd = io_spec_get_fd(io);
...
VALUE
io_spec_rb_thread_fd_select_timeout(VALUE self, VALUE io)
{
    int fd = io_spec_get_fd(io);
