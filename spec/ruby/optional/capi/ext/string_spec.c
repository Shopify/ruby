...
VALUE
string_spec_rb_str_conv_enc_opts(VALUE self, VALUE str, VALUE from, VALUE to,
...
VALUE
string_spec_RSTRING_PTR_null_terminate(VALUE self, VALUE str, VALUE min_length)
{
