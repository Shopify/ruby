...
static VALUE
get_registered_before_rb_gc_register_address(VALUE self)
{
    return registered_before_rb_gc_register_address;
}

static VALUE
get_registered_before_rb_global_variable(VALUE self)
{
    return registered_before_rb_global_variable;
}

static VALUE
gc_spec_rb_gc_register_address(VALUE self)
{
...
static VALUE
gc_spec_rb_gc_unregister_address(VALUE self)
{
