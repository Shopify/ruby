...
static VALUE
module_specs_rb_define_alias(VALUE self, VALUE obj,
...
static VALUE
module_specs_rb_alias(VALUE self, VALUE obj,
  VALUE new_name, VALUE old_name)
{
...
static VALUE
module_specs_method_var_args_1(int argc, VALUE *argv, VALUE self)
{
...
static VALUE
module_specs_method_var_args_2(VALUE self, VALUE argv)
{
    return argv;
}

static VALUE
module_specs_rb_define_method_1required(VALUE self, VALUE arg1)
{
    return arg1;
}

static VALUE
module_specs_rb_define_method_2required(VALUE self, VALUE arg1, VALUE arg2)
{
    return arg2;
}
