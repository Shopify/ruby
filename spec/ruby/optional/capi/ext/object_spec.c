...
static VALUE
so_rb_obj_call_init(VALUE self, VALUE object,
...
static VALUE
so_is_rb_type_p_file(VALUE self, VALUE obj)
{
...
static int
foreach_f(ID key, VALUE val, VALUE ary)
{
...
static VALUE
object_spec_rb_ivar_foreach(VALUE self, VALUE obj)
{
