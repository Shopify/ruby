...
VALUE
kernel_spec_rb_ensure(VALUE self, VALUE main_proc, VALUE arg,
...
VALUE
kernel_spec_rb_eval_cmd_kw(VALUE self, VALUE cmd, VALUE args, VALUE kw_splat)
{
...
VALUE
kernel_spec_rb_rescue(VALUE self, VALUE main_proc, VALUE arg,
